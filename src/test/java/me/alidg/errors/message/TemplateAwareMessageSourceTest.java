...
/**
 * Tests for the {@link TemplateAwareMessageSource}.
 *
 * @author zarebski-m
 */
@RunWith(JUnitParamsRunner.class)
public class TemplateAwareMessageSourceTest {
    ...
    public void messageInterpolation_WithNamedArguments(String template, List<Argument> arguments, String expectedMessage) {
        TemplateAwareMessageSource interpolator = new TemplateAwareMessageSource(messageSource);
